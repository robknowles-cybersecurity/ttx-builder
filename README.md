...
| **Ghost in the Pipeline** — an AI agent with borrowed keys, a night of work nobody asked for, and three stories that all fit the logs. | `ghost-in-the-pipeline` | Live |
